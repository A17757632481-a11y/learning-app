...
export function Layout() {
  ...
  // 判断当前是否在学习相关页面
  const isLearnPage = ['/term', '/learn', '/coding-basics', '/review', '/smart-review', '/chinese-learn', '/math-learn', '/biology-learn'].includes(location.pathname);
  // 判断当前是否在工具相关页面
          ...
          >
            ...
            {showLearnMenu && (
              ...
              >
                ...
                <NavLink to="/biology-learn" className="dropdown-item" onClick={() => setShowLearnMenu(false)}>
                  🧬 生物学习
                </NavLink>
              </div>
            )}
